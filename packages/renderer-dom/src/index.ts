/**
 * @presentation/renderer-dom — placeholder package. No engine implementation yet.
 *
...
export const PACKAGE_NAME: "@presentation/renderer-dom" = "@presentation/renderer-dom";
