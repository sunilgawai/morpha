/**
 * @presentation/renderer-ssr — placeholder package. No engine implementation yet.
 *
...
export const PACKAGE_NAME: "@presentation/renderer-ssr" = "@presentation/renderer-ssr";
