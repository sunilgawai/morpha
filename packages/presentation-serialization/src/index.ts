/**
 * presentation-serialization — placeholder package. No engine implementation yet.
 *
...
export const PACKAGE_NAME: "presentation-serialization" = "presentation-serialization";
